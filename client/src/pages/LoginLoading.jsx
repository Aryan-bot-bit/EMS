...
import LoginLeftSide from "../assets/components/LoginLeftSide"
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-mxl font-medium text-slate-900 tracking-tight mb-3">
              Welcome back
            </h2>
          ...
          {/* Portal Options */}
          <p className="text-sm text-slate-500 mb-2">Portal Options</p>
          ...
          <div className='mt-12 text-center md:text-left text-sm text-slate-400'>
            <p>@ {new Date().getFullYear()} Aryan Tomar. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
